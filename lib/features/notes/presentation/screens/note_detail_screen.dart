                  ...
                  : SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_note!.attachments.isNotEmpty) ...[
                            ...
                            ..._note!.attachments.map((attachment) {
                              return Card(
                                child: ListTile(
                                  leading: const Icon(Icons.attachment),
                                  title: Text(attachment.displayFilename),
                                  subtitle: attachment.displaySize > 0
                                      ? Text('${(attachment.displaySize / 1024).toStringAsFixed(2)} KB')
                                      : const Text('Unknown size'),
                                  onTap: () => _launchUrl(attachment.url),
                                  trailing: IconButton(
                                    icon: const Icon(Icons.delete_outline, color: Colors.red),
                                    onPressed: () async {
                          ...
                          if (_note!.sharedWith.isNotEmpty) ...[
                            const SizedBox(height: 16),
                            Text(
                              'Shared with ${_note!.sharedWith.length} people',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ],
